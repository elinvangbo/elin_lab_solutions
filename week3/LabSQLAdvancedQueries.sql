...
#2. For each film, list actor that has acted in more films. For each film, 
#check the list of actors and get a list with the number of films for each one and take the first one. 
